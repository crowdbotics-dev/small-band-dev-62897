"""
Django settings for small_band_dev_62897 project.
...
ROOT_URLCONF = 'small_band_dev_62897.urls'
...
WSGI_APPLICATION = 'small_band_dev_62897.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_band_dev_62897 API",
    "DESCRIPTION": "API documentation for small_band_dev_62897 App",
    "VERSION": "v1",
}
